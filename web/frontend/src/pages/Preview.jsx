...
const VERIFIED_ARTIST = {
  ...
  threat_category: '',
  evidence_json: [
    { finding: 'Found on Deezer with 2,145,231 fans', source: 'Deezer', type: 'green_flag', strength: 'strong', tags: ['multi_platform', 'genuine_fans'], detail: 'Major Deezer presence' },
    ...
    { finding: '4,523,109 Last.fm listeners with 89,234,001 scrobbles', source: 'Last.fm', type: 'green_flag', strength: 'strong', tags: ['genuine_fans'], detail: 'Play/listener ratio: 19.7' },
    ...
    { finding: '8 albums, 24 singles \u2014 healthy release cadence', source: 'Spotify', type: 'green_flag', strength: 'strong', tags: ['catalog_albums'], detail: 'Active since 2012. Average duration 3:42. \u03C3 = 0:48' },
    ...
    { finding: '342 concerts on Setlist.fm across 28 countries', source: 'Setlist.fm', type: 'green_flag', strength: 'strong', tags: ['live_performance', 'touring_geography'], detail: 'Extensive touring history 2015\u2013present' },
...
const AUTHENTIC_ARTIST = {
  ...
  evidence_json: [
    ...
    { finding: '6 albums, 18 singles \u2014 normal release cadence', source: 'Spotify', type: 'green_flag', strength: 'strong', tags: ['catalog_albums'], detail: 'Active since 2014. Average duration 4:32. \u03C3 = 0:58' },
...
const INCONCLUSIVE_ARTIST = {
  ...
  evidence_json: [
    ...
    { finding: '3 albums, 7 singles', source: 'Spotify', type: 'green_flag', strength: 'moderate', tags: ['catalog_albums'], detail: 'Active since 2019. Average duration 4:12. \u03C3 = 1:23' },
...
const SUSPICIOUS_ARTIST = {
  ...
  evidence_json: [
    ...
    { finding: '38 singles, 0 albums (content farm pattern)', source: 'Spotify', type: 'red_flag', strength: 'strong', tags: ['content_farm', 'high_release_rate'], detail: 'Active since 2022. Average duration 1:52. \u03C3 = 0:08' },
    ...
    { finding: 'No social media profiles found', source: 'Analysis', type: 'red_flag', strength: 'moderate', tags: ['no_social_media'], detail: '' },
    { finding: 'No genres listed on Spotify', source: 'Spotify', type: 'red_flag', strength: 'weak', tags: ['no_genres'], detail: '' },
...
const ARTIFICIAL_ARTIST = {
  ...
  evidence_json: [
    ...
    { finding: '87 singles, 0 albums in 14 months', source: 'Spotify', type: 'red_flag', strength: 'strong', tags: ['content_farm', 'high_release_rate', 'empty_catalog'], detail: 'Active since 2024. Average duration 1:38. \u03C3 = 0:05' },
    ...
    { finding: 'No Wikipedia article', source: 'Wikipedia', type: 'red_flag', strength: 'weak', tags: [], detail: '' },
